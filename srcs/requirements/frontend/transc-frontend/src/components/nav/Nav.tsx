    ...
    return (
        <>
            <div className={`${" md:col-span-2 lg:col-span-3 2xl:col-span-3 "}}`}>
                ...
                <div className={`${isCreateChannelOn.createChannelBtnToggled ? "hidden" : ""} && ${(isMdScreen || isOpen) ? " h-screen w-screen bg-primary-900 flex justify-evenly flex-col items-center       md:h-[100vh] md:w-full  lg:h-screen" : "hidden"} `}>
                    <div className=" bg-cyan-500 w-screen h-[100px] flex items-center justify-center px-[27px]      md:hidden">
                        <div className="flex items-center ">
                            <button
                    ...
                    <div className={`${" flex flex-col items-center justify-evenly gap-[10%] self-center h-fit w-[128px]      md:justify-start md:h-full      lg:justify-between lg:w-[70%] lg:h-full      xl:w-[100%]"}`}>
                        ...
                        <div className=" bg-red-500 flex flex-col items-center gap-[8px] w-[128px] h-full overflow-auto no-scrollbar                md:h-full md:justify-center  md:relative  md:pt-[30px]       lg:w-full lg:h-[80%] lg:justify-start lg:flex-1 lg:gap-[15px]  ">
                            ...
                            <div className={`${isLgScreen ? "w-[100%] h-[50px] flex items-center pl-[32px] rounded-full lg:bg-green-500      lg:h-[100px]  lg:w-[100%] xl:w-[280px]" : "hidden"}`}>
