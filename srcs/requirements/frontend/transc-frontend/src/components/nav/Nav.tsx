...
export default function Nav({title, setIsOpen, isOpen}: {title :string,
    ...
    return(
<>
<div className={`${" md:col-span-2 lg:col-span-3 bg-green-400 "}   }`}>
    ...
    <div className={`${(isMdScreen || isOpen) ? " h-screen w-screen md:h-full md:w-full bg-primary-900 flex  flex-col items-center justify-center" : "hidden"} `}>
        ...
        <div className={`flex flex-col items-center justify-evenly md:justify-between lg:justify-start lg:gap-[159px] h-full w-[128px] `}>
            ...
            <div className="flex flex-col items-center w-[128px] ">
                <div className={`${!isLgScreen ? "border-[1px] md:bg-transparent md:border-none border-white w-full h-[60px] xs:h-[50px] xxs:h-[50px] flex justify-center items-center rounded-full bg-white md:mb-[67px]" : "hidden"}`}>
                            <img src="/imgs/logout.png" alt="profile" className="w-[30px] h-[30px] md:w-[40px] md:h-[40px]"/>
                </div>
                    <div className= {`${isLgScreen ? "w-[230px] h-[50px] flex items-center justify-center rounded-full bg-white mt-[255px]" : "hidden"}`}>
