        ...
        <div className='mt-5 h-full w-full lg:w-[70%]'>
          ...
          <div className='md:flex items-sart justify-center gap-2 m-auto'>
            <div className='flex flex-col-reverse md:flex-col'>
              ...
              <button className='border-2 gradient-bg shadow-xl ml-auto mr-auto md:mr-0 text-primary text-[20px] p-2 w-[268px] h-[61px] rounded-[40px] md:ml-4 mt-10 hover:bg-primary ease-in duration-300 hover:text-white hover:border-none' onClick={() => setClose(true)}>
                Random player
              </button>
            </div>
