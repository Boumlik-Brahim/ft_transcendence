...
function loading() {
  return (
    <div className="layouts">
      ...
      <div className="wrapper loading_animation relative rounded-2xl">
          ...
          <div className=" bg-slate-100 flex flex-col gap-[30px] items-center justify-center w-[200px] xs:w-[300px] md:w-[400px] rounded-2xl px-[1rem] py-[1rem] xs:py-[3rem]">
            <div className="w-[200px] h-[200px] rounded-full "></div>
            <div className="flex flex-col items-center gap-[10px] w-[80%]">
              <div className='flex xs:justify-between justify-center w-full items-center  bg-slate-200 h-[40px] rounded-2xl'></div>
              <div className='flex xs:justify-between justify-center w-full items-center  bg-slate-200 h-[40px] rounded-2xl'></div>
            </div>
          </div>
        </div>

        <div className="wrapper loading_animation relative">
          <p className=" bg-slate-100 w-[350px] h-[50px] self-start rounded-2xl "></p>
          <ul className="w-full flex gap-[10px] flex-wrap">
            <li className="w-[150px] h-[50px] bg-slate-200 rounded-2xl "></li>
            <li className="w-[150px] h-[50px] bg-slate-200 rounded-2xl "></li>
            <li className="w-[150px] h-[50px] bg-slate-200 rounded-2xl "></li>
            <li className="w-[150px] h-[50px] bg-slate-200 rounded-2xl "></li>
          </ul>
        ...
        <div className="wrapper loading_animation relative">
          ...
          <ul className="w-full flex flex-col gap-[20px] flex-wrap">
            <li className="w-full h-[70px] bg-slate-200 rounded-full "></li>
            <li className="w-full h-[70px] bg-slate-200 rounded-full "></li>
          </ul>
        </div>
      </div> 
