...
function MemberBoxInfoLg({ userId ,channelId, userName, profilePic }: {userId:string ,channelId: string, userName: string, profilePic: string }) {
    ...
    return (
        <>
            ...
            <div className="w-full h-[22%] flex pl-[1%] " >
...
export default MemberBoxInfoLg;