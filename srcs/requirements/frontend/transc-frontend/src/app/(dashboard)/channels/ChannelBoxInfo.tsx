...
function ChannelBoxInfo({id,bg_color,txt_color,channel_name,channel_owner, channel_members, channel_mode} : ChannelProps) {
    return (
        <div className="w-full h-[46px] border-2 border-primary rounded-full text-white flex items-center justify-between pl-[19px] pr-[11px] mb-[9px] cursor-pointer   md:h-[78px]     lg:h-[60px]">
            <div className="w-[80px] h-[25px]  flex flex-col justify-center md:w-[100px] md:h-[35px]">
                <div className="w-full text-[9px] text-primary font-bold leading-tight tracking-wider truncate   md:text-[12px]">
                    {channel_name}
                </div>
            ...
            <div className="w-[80px] h-[25px]  text-[9px] text-primary font-bold leading-tight tracking-wider flex justify-center items-center   md:w-[100px] md:h-[35px] md:text-[12px]">
