...
function AdminBoxInfoMd({ userId, channelId, userName, profilePic }: { userId: string, channelId: string, userName: string, profilePic: string }) {
        ...
        <>
            <div className="w-full h-[20%] ">
                <div className="w-full h-full  flex">
                    <div className={`${`h-full  ${showActionsBtn ? "w-[70%] justify-end" :" w-full justify-center" }  flex items-center   relative`}`}>
                    ...
                    {showActionsBtn && <div className="h-full w-[30%] flex items-center  pl-[7px] ">
